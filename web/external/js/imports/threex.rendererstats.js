...
THREEx.RendererStats	= function (){
	...
	return {
		...
		update: function(webGLRenderer){
			...
			var i	= 0;
			msTexts[i++].textContent = "== Game =====";
			msTexts[i++].textContent = "Terrain: " + Object.keys(WORLDMANAGER.loadedTerrain).length;
			msTexts[i++].textContent = "Visible: " + GRAPHICS.scene.visibleCount;
			msTexts[i++].textContent = "Sprites: " + 0;
